...
2. **同步上游域名列表**：
   ...
   - 代理列表 (proxy-list)：包含[代理访问的域名](https://raw.githubusercontent.com/Loyalsoldier/v2ray-rules-dat/release/proxy-list.txt)、[GFWList 域名列表](https://raw.githubusercontent.com/Loyalsoldier/v2ray-rules-dat/release/gfw.txt)
   - 屏蔽列表 (reject-list)：包含[广告域名](https://raw.githubusercontent.com/Loyalsoldier/v2ray-rules-dat/release/reject-list.txt)
